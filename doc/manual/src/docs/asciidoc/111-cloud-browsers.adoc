...
plugins {
    id("org.apache.groovy.geb.saucelabs") version "{geb-version}" //<1>
}
...
plugins {
    id("org.apache.groovy.geb.browserstack") version "{geb-version}" //<1>
}
...
plugins {
    id("org.apache.groovy.geb.lambdatest") version "{geb-version}" //<1>
}
